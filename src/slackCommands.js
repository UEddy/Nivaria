...
function notLinkedMessage(appUrl) {
  return {
    response_type: 'ephemeral',
    text: `Your Slack account isn't linked to Nivaria yet. Open <${appUrl}/app#/profile/integrations|Profile in Nivaria> and click "Add to Slack" to connect, then try again.`,
  };
}
